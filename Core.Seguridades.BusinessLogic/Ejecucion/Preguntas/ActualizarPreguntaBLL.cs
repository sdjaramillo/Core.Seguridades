...
{
    public static class ActualizarPreguntaBLL
    {
        public static void ActualizarPregunta(PreguntaTrx objetoTransaccional)
        {
            ActualizarPreguntaDAL.Execute(objetoTransaccional);
        }
    }
}
